...
Drawing a line, in this case, from where the mouse last was to where the mouse currently is.
...
[http://jsfiddle.net/tqrdhy8u/](http://jsfiddle.net/tqrdhy8u/)
...
function onMouseMove(event) {
	...
	if(event.x < 100 && event.y < 100) { //upper left
		ctx.fillStyle = "#FF0000";
		drawing.fillRect(0,0,100,100);
	} else if (event.x < 100 && event.y > 100 { //lower left
		ctx.fillStyle = "#00FF00";
		drawing.fillRect(0,100,100,100);
	} else if(event.x > 100 && event.y < 100) { // upper right
		drawing.fillStyle = "#00FF00";
		drawing.fillRect(100,0,100,100);
	} else if(event.x > 100 && event.y > 100) { // lower right
		drawing.fillStyle = "#00FF00";
		drawing.fillRect(100,100,100,100);
	}
}
